...
requestify.post('http://localhost:5000/setSensor', {sensor: "Lampe_Bureau", action: "ExecuteCommand", parameters: {ElementName: 'Lampe_Bureau', Command: "Off"}}).then(function(response) {
    // Get the response body (JSON parsed or jQuery object for XMLs)
    console.log(response.getBody());
});